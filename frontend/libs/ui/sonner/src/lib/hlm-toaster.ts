  ...
  template: `
		...
		>
			<ng-template #loadingIcon>
				<ng-icon name="lucideLoader2" class="
      overflow-visible! text-base motion-safe:[&>svg]:animate-spin
    " />
			</ng-template>
...
{
  public readonly invert = input<ToasterProps["invert"], BooleanInput>(false, { transform: booleanAttribute })
  ...
  public readonly richColors = input<ToasterProps["richColors"], BooleanInput>(false, { transform: booleanAttribute })
  public readonly expand = input<ToasterProps["expand"], BooleanInput>(false, { transform: booleanAttribute })
  public readonly duration = input<ToasterProps["duration"], NumberInput>(4000, { transform: numberAttribute })
  public readonly visibleToasts = input<ToasterProps["visibleToasts"], NumberInput>(3, { transform: numberAttribute })
  public readonly closeButton = input<ToasterProps["closeButton"], BooleanInput>(false, { transform: booleanAttribute })
