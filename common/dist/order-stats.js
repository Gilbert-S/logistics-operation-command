const itemQuantityReducer = (sum, item) => sum + item.quantity;
const itemDeliveredReducer = (sum, item) => sum + item.delivered;
const itemInDeliveryReducer = (sum, item) => sum + item.inDelivery;
export const highFilter = (item) => item.priority === "high";
export const mediumFilter = (item) => item.priority === "medium";
export const lowFilter = (item) => item.priority === "low";
export function updateOrderStats(order) {
...
//# sourceMappingURL=order-stats.js.map